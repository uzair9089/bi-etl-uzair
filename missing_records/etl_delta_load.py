...
,'appointment_series': " create  table if not exists  appointment_series as select  a.* from missing_records.appointment_series a left join core.appointment_series b ON a.updated_at = b.updated_at and a.id = b.id WHERE b.updated_at is NULL and b.id is null AND a.updated_at is not NULL and a.id is not NULL; insert into core.appointment_series select * from appointment_series;  delete from stage.s_appointment_series where id in select distinct id from appointment_series;insert into stage.s_appointment_series select * from appointment_series;"
